...
GAME_MAP_START = (0, 64)  # GAME_MAP_START is the screen coordinates where the top left of the game map is displayed
GAME_POS_SIZE = (int(GAME_MAP_SIZE[0] / GAME_MAP_GRID[0]), int(GAME_MAP_SIZE[1] / GAME_MAP_GRID[1]))  # pixel scale
